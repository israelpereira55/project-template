...
// configuration step. It creates a namespace called `project_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", project_template::cmake::project_name, project_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", project_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
